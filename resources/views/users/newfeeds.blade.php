								...
								<div class="central-meta item">
									<div class="user-post">
										...
										<div>
											...
											<button type="submit" id="myBtn" href="/posts/{{$value['id']}}/edit" class="btn btn-primary mt-2">Edit</button>
											...
											<ul class="we-comet">
												...
												<li class="post-comment">
													...
													<div class="post-comt-box">
														...
														@csrf
															<textarea style="color: #000000" placeholder="" name="comment_description"></textarea>
