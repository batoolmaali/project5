...
<div class="theme-layout">
	...
	<script data-cfasync="false" src="{{asset('layoutpublic../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js')}}"></script><script src="{{asset('layoutpublicjs/main.min.js')}}"></script>
	<script src="{{asset('layoutpublicjs/script.js')}}"></script>
